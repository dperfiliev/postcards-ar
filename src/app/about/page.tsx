                ...
                <div className={styles.info}>
                    <div className={styles.section}>
                        ...
                        <p className="text">
                            ...
                            Такой формат превращает подарок в настоящее чудо!

                            Все что нужно сделать — это <Link className={styles.link} href="/ar-markers"> выбрать открытку </Link>, распечатать ее на бумаге, разместить на носителе, например, упаковке конфет, а затем подарить.
