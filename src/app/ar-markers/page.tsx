...
export default function ArMarkers() {
    ...
    const data = [
        ...
        { id: "2", name: "Новый год (Белочка)", icon: "/images/icons/list/squirrel_gift.png", marker: "/images/markers/squirrel_gift.jpg", download: "/images/downloads/squirrel_gift.png", model: "./models/squirrel_gift/scene.glb", modelName: "Белочка с подарком", description: "Модель белки с пушистым хвостом передаёт атмосферу лесной сказки и приносит чувство восторга." },
        { id: "3", name: "Новый год (Снеговик)", icon: "/images/icons/list/snowman.png", marker: "/images/markers/snowman.jpg", download: "/images/downloads/snowman.png", model: "./models/snowman/scene.glb", modelName: "Снеговик", description: "Модель снеговика с весёлыми глазами и тёплым шарфом приносит ощущение уюта и праздничного настроения." },
        { id: "4", name: "Новый год (Ёлка)", icon: "/images/icons/list/tree.png", marker: "/images/markers/tree.jpg", download: "/images/downloads/tree.png", model: "./models/tree/scene.glb", modelName: "Ёлка", description: "Модель новогодней елки с яркими шарами создаёт атмосферу праздника и волшебства, принося радость и тепло в каждый дом." },
        { id: "5", name: "День рождения (Торт)", icon: "/images/icons/list/cake.png", marker: "/images/markers/cake.jpg", download: "/images/downloads/cake.png", model: "./models/cake/scene.glb", modelName: "Помадковый торт", description: "Праздничный торт с розовым кремом, украшенный свечами и ягодами, создаёт атмосферу праздника и радости."},
        { id: "6", name: "День рождения (Подарок)", icon: "/images/icons/list/gift.png", marker: "/images/markers/gift.jpg", download: "/images/downloads/gift.png", model: "./models/gift/scene.glb", modelName: "Подарок с бантом", description: "Подарок, упакованный в яркую обёрточную бумагу и украшенный большим бантом, создаёт праздничное настроение."},
        { id: "7", name: "День святого Валентина", icon: "/images/icons/list/heart.png", marker: "/images/markers/heart.jpg", download: "/images/downloads/heart.png", model: "./models/heart/scene.glb", modelName: "Сердце", description: "Модель красного сердца с гладкой текстурой и насыщенным цветом, создаёт атмосферу любви и нежности."},
        { id: "8", name: "День Победы", icon: "/images/icons/list/nine.png", marker: "/images/markers/nine.jpg", download: "/images/downloads/nine.png", model: "./models/nine/scene.glb", modelName: "Георгиевская лента", description: "Символ героизма, военной доблести и славы защитников." },
        ...
        { id: "10", name: "Международный женский день", icon: "/images/icons/list/rose.png", marker: "/images/markers/rose.jpg", download: "/images/downloads/rose.png", model: "./models/rose/scene.glb", modelName: "Бутон розы", description: "Изящные лепестки, глубокий и насыщенный цвет этой розы, символизируют силу и красоту женщин." },
        ...
        { id: "12", name: "День знаний", icon: "/images/icons/list/bell.png", marker: "/images/markers/bell.jpg", download: "/images/downloads/bell.png", model: "./models/bell/scene.glb", modelName: "Колокольчик", description: "Колокольчик с золотистым корпусом и яркой красной лентой, аккуратно завязанной вокруг ручки, символизирует начало учебного года."},
    ];
