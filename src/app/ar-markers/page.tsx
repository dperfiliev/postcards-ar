...
export default function ArMarkers() {
    ...
    const data = [
        ...
        { id: "8", name: "День Победы", icon: "/images/icons/list/nine.png", marker: "/images/markers/nine.jpg", download: "/images/downloads/nine.png", model: "./models/nine/scene.glb", modelName: "Без названия", description: "Доработать текст" },
