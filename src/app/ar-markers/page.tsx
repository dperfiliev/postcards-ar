...
export default function ArMarkers() {
    ...
    const data = [
        { id: "1", name: "Новый год (Снеговик)", icon: "/images/icons/list/snowman.png", marker: "/images/markers/snowman.jpg", download: "/images/downloads/snowman.png", model: "./models/snowman/scene.glb", modelName: "Снеговик", description: "Модель снеговика с весёлыми глазами и тёплым шарфом приносит ощущение уюта и праздничного настроения." },
        { id: "2", name: "Новый год (Белочка)", icon: "/images/icons/list/squirrel_gift.png", marker: "/images/markers/squirrel_gift.jpg", download: "/images/downloads/squirrel_gift.png", model: "./models/squirrel_gift/scene.glb", modelName: "Белочка с подарком", description: "Пушистая белочка с подарком в лапках приносит радость зимнего праздника и сказочное настроение." },
        { id: "3", name: "Новый год (Ёлка)", icon: "/images/icons/list/tree.png", marker: "/images/markers/tree.jpg", download: "/images/downloads/tree.png", model: "./models/tree/scene.glb", modelName: "Ёлка", description: "Модель новогодней елки с яркими шарами наполняет праздник радостью и волшебством, создает атмосферу зимней сказки." },
        { id: "4", name: "Международный женский день", icon: "/images/icons/list/rose.png", marker: "/images/markers/rose.jpg", download: "/images/downloads/rose.png", model: "./models/rose/scene.glb", modelName: "Бутон розы", description: "Изящные лепестки, глубокий и насыщенный цвет этой розы, символизируют силу и красоту женщин." },
